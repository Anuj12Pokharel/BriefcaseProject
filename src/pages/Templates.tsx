...
type MessageTemplate = { id: string; title: string; body: string; updatedAt?: number };
...
export default function Templates() {
  ...
  // message templates stored in localStorage (managed by ManageTemplates page)
    ...
    const onStorage = (e: StorageEvent) => {
      if (e.key === 'messageTemplates') {
        try {
          ...
          setMessageTemplates(parsed.map((t: any) => ({ ...t, updatedAt: t.updatedAt || Date.now() })));
        } catch (err) {
          // ignore
        }
      }
  ...
  const templates = [
    { id: 1, name: 'Employment Contract', category: 'HR', description: 'Standard employment agreement template', downloads: 1243, popular: true },
    { id: 2, name: 'Non-Disclosure Agreement', category: 'Legal', description: 'Mutual NDA for confidential information', downloads: 2156, popular: true },
    { id: 3, name: 'Service Agreement', category: 'Business', description: 'Client service contract template', downloads: 987, popular: false },
    { id: 4, name: 'Vendor Contract', category: 'Procurement', description: 'Vendor services agreement', downloads: 654, popular: false },
    { id: 5, name: 'Consulting Agreement', category: 'Business', description: 'Independent contractor agreement', downloads: 1876, popular: true },
    { id: 6, name: 'Lease Agreement', category: 'Real Estate', description: 'Commercial property lease', downloads: 543, popular: false },
    { id: 7, name: 'Partnership Agreement', category: 'Legal', description: 'Business partnership contract', downloads: 765, popular: false },
    { id: 8, name: 'Sales Contract', category: 'Sales', description: 'Product or service sales agreement', downloads: 1432, popular: true }
  ];
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">Choose from our library of professionally crafted templates</p>
        </div>

        <div className="flex flex-col lg:flex-row gap-6 mb-8">
          <div className="flex-1 relative">
            <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
            <input type="text" placeholder="Search templates..." className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white" />
          </div>
